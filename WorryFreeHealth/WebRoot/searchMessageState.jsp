...
<html>
  ...
  <body>
 		 ...
 		 <tr>
    		    <td width="99%" align="left" valign="top">您的位置：咨询信息管理&nbsp;&nbsp;>&nbsp;&nbsp;查询咨询信息状态</td>
  		</tr>
  		<tr>
    			...
    			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  				<tr>
   		 			<td width="90%" align="left" valign="middle">
	         			<form method="post" action="searchMessageState">
	         				<span>咨询信息：</span>
	        				<input type="text" name="messageId" value="" class="text-word">
			...
			<h3 style="color:red">没有找到相关信息!</h3>
    			...
    			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
     				...
     				<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        			...
	        			<td align="center" valign="middle" class="borderbottom"><a href="searchThenDeleteMessage.action?messageId=<s:property value="#message.messageId"/>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      				</tr>
      				</s:iterator>
  					<tr>
