...
<body>
	<table width="99%" border="0" cellspacing="0" cellpadding="0"
		id="searchmain">
		<tr>
			<td width="99%" align="left" valign="top">您的位置：管理员管理&nbsp;&nbsp;>&nbsp;&nbsp;查询</td>
		</tr>
		<tr>
			<td align="left" valign="top"><a href="main.jsp"
					...
					<tr>
						<td width="90%" align="left" valign="middle">
							<form method="post" action="adminSearch">
								<span>管理员：</span> <input type="text" name="adminId" value=""
						...
						<td width="10%" align="center" valign="middle"
							...
							href="addAdmin.jsp" target="mainFrame" onFocus="this.blur()"
							class="add">新增管理员</a></td>
					</tr>
				</table>
			</td>
		</tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<s:iterator value="admin" id="admin" status="st">
							<tr onMouseOut="this.style.backgroundColor='#ffffff'"
								...
								</span><a href="deleteAdminById.action?adminId=<s:property value="#admin.adminId"/>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
							</tr>
						    </s:iterator>
							<tr>
								<td align="center" valign="middle"  colspan="5" class="fenye"><s:property value="#request.count"></s:property>条数据 1/1
