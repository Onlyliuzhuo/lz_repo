...
<html>
  ...
  <body>
  	<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  		<tr>
   			<td width="99%" align="left" valign="top" id="addinfo">您的位置：咨询信息管理&nbsp;&nbsp;>&nbsp;&nbsp;审核咨询信息</td>
  		</tr>
   		<tr>
			...
			<h3 style="color:red">没有找到相关信息!</h3>
    			...
    			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
     				...
     				<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        			...
	        			<td align="center" valign="middle" class="borderbottom"><a href="examineMessage.action?messageId=<s:property value="#message.messageId"/>" target="mainFrame" onFocus="this.blur()" class="add">通过</a><span class="gray">
	        			&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;</span><a href="examinThenDeleteMessage.action?messageId=<s:property value="#message.messageId"/>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      				</tr>
      				</s:iterator>
  					<tr>
