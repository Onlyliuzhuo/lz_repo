  		...
  		<h3 style="color:red">没有找到相关信息!</h3>
    			...
    			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
     				...
     				<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        			...
	        			<td align="center" valign="middle" class="borderright borderbottom"><s:if test="#orderList.orderListIsCancel==1">已取消</s:if><s:else>未取消</s:else></td>
	        			<td align="center" valign="middle" class="borderright borderbottom"><s:if test="#orderList.orderListIsFinish==1">已完成</s:if><s:else>未完成</s:else></td>	        				        				        			
	        			<td align="center" valign="middle" class="borderbottom"><a href="deleteOrderList.action?orderListId=<s:property value="#orderList.orderListId"/>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      				</tr>
      				</s:iterator>
  					<tr>
