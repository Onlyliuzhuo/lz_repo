...
<html>
  ...
  <body>
 		 ...
 		 <tr>
    		    <td width="99%" align="left" valign="top">您的位置：患者管理&nbsp;&nbsp;>&nbsp;&nbsp;查询</td>
  		</tr>
  		<tr>
  		...
  		<h3 style="color:red">没有找到相关信息!</h3>
    			...
    			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
     				...
     				<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        			...
	        			<td align="center" valign="middle" class="borderbottom"><a href="searchThenDelete.action?patientId=<s:property value="#patient.patientId"></s:property>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      				</tr>
      				</s:iterator>
  					<tr>
