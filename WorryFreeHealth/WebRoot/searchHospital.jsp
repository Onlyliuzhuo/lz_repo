...
<html>
  ...
  <body>
 		 ...
 		 <tr>
    		<td width="99%" align="left" valign="top">您的位置：医院管理&nbsp;&nbsp;>&nbsp;&nbsp;查询</td>
  		 </tr>
  		 <tr>
    			...
    			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
  				<tr>
   		 			<td width="90%" align="left" valign="middle">
	         			<form method="post" action="searchHospital">
	         				<span>医院：</span>
	        				<input type="text" name="hospitalID" value="" class="text-word">
	         				<input type="submit" value="查询" class="text-but">
	         			</form>
         			</td>
         				<td width="10%" align="center" valign="middle" style="text-align:right; width:150px;"><a href="addHospital.jsp" target="mainFrame" onFocus="this.blur()" class="add">新增医院</a></td>
  					</tr>
				</table>
    		</td>
  		</tr>
  		...
  		<h3 style="color:red">没有找到相关信息!</h3>
    			...
    			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
     				...
     				<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        			...
	        			<td align="center" valign="middle" class="borderright borderbottom"><a href="<s:property value="#hospital.hospitalWebsite"/>"  target="_blank" onFocus="this.blur()"><s:property value="#hospital.hospitalWebsite"/></a></td>
	        			...
	        			<td align="center" valign="middle" class="borderbottom"><a href="SearchThenUpdateHospitalMessage.action?hospitalId=<s:property value="#hospital.hospitalId"/>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
	        				</span><a href="searchThenDeleteHospital.action?hospitalId=<s:property value="#hospital.hospitalId"/>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
	        			<td align="center" valign="middle" class="borderbottom"><a href="SearchHospitalMessage.action?hospitalId=<s:property value="#hospital.hospitalId"/>" target="mainFrame" onFocus="this.blur()" class="add">查看详细信息</a></td>
      				</tr>
      				</s:iterator>
  					<tr>
