...
<html>
  ...
  <tr>
    <td width="99%" align="left" valign="top" id="addinfo">您的位置：患者管理&nbsp;&nbsp;>&nbsp;&nbsp;审核患者</td>
  </tr>
   <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
     				...
     				<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
	        			...
	        			<td align="center" valign="middle" class="borderbottom"><a href="examinPatient.action?patientId=<s:property value="#patient.patientId"/>" target="mainFrame" onFocus="this.blur()"
						class="add">通过</a><span class="gray">&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
						</span><a href="ExaminThenDeletePatientById.action?patientId=<s:property value="#patient.patientId"/>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      				</tr>
      				</s:iterator>
  					<tr>
